    ...
    <div class="container">
      ...
      <form @submit.prevent="updateCampaign">
        <div class="form-group">
          ...
          <input type="text" v-model="campaign.name" class="form-control" id="campaignname" required />
        </div>

        <div class="form-group">
          <label for="campaigndescription">Campaign Description:</label>
          <textarea v-model="campaign.description" class="form-control" id="campaigndescription" required></textarea>
        </div>

        <div class="form-group">
          <label for="campaigngoals">Campaign Goals:</label>
          <textarea v-model="campaign.goals" class="form-control" id="campaigngoals" required></textarea>
        </div>

        <div class="form-group">
          <label for="campaignniche">Campaign Niche:</label>
          <input type="text" v-model="campaign.niche" class="form-control" id="campaignniche" required />
        </div>

        <div class="form-group">
          <label for="campaignbudget">Campaign Budget:</label>
          <input type="number" v-model="campaign.budget" class="form-control" id="campaignbudget" min="0" required />
        </div>

        <div class="form-group">
          <label for="campaignvisibility">Campaign Visibility:</label>
          <div>
            <input type="radio" v-model="campaign.visibility" value="public" id="public" />
            <label for="public">Public</label>
            <br />
            <input type="radio" v-model="campaign.visibility" value="private" id="private" />
        ...
        <div class="form-group">
          ...
          <input type="date" v-model="campaign.startDate" class="form-control" id="campaignstartdate" required />
        </div>

        <div class="form-group">
          <label for="campaignenddate">Campaign End Date:</label>
          <input type="date" v-model="campaign.endDate" class="form-control" id="campaignenddate" required />
        </div>
    ...
    async updateCampaign() {
      ...
      try {
        ...
        if (response.data.success) {
            this.successMessage = "Campaign updated successfully ! Redirecting to Dashboard !!";
        ...
        this.messages = [{ message: error.response.data.message || "An error occurred", type: "error" }];
      }
    },
